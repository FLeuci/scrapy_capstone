...
def parse_dtts(date_str, src_format):
    """
    Edits a date to the needed format
    """
...
def flatten(list_of_list, func):
    """
    Combines more elements of different list all in one unique list
    """
...
def reduce_by_key(list_of_tuple_2):
    """
    Returns a dict with reduced by key elements
    """
    res = dict()
